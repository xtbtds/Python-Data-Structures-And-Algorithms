...
* :blue_square: Stack
* :blue_square: Queue
* :yellow_square: [Linked List](https://github.com/xtbtds/Python-Data-Structures-And-Algorithms/blob/main/DataStructures/Linked_List.py) - create :white_check_mark: insert :blue_square: delete node :blue_square: delete linked list :blue_square:
